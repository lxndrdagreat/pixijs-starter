...
import { type Scene, type SceneLoader, SceneManager } from '@/core/scene';
import Time from '@/core/time';
import { type AutoDetectOptions, autoDetectRenderer, Container, type Renderer } from 'pixi.js';
import Stats from 'stats.js';

interface GameOptions {
  frame: HTMLElement;
  renderOptions?: Partial<AutoDetectOptions>;
  initialScene?: SceneLoader;
